...
function fps_solve(
  ...
  SolverCore.solve!(meta, stp, stats; subsolver_verbose = subsolver_verbose, verbose = verbose)
...
function fps_solve(stp::NLPStopping; subsolver_verbose::Int = 0, verbose::Int = 0, kwargs...)
  nlp = stp.pb
