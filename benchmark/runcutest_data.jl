...
function runcutest(; today :: String = string(today()))
  ...
  _pnames = CUTEst.select(max_var=10000, min_con=1, max_con=10000, only_free_var=true, only_equ_con=true, objtype=3:6)
...
#                                             x0 = nlp.meta.x0),
                :FPS => nlp -> Fletcher_penalty_solver(nlp, nlp.meta.x0,
                                                          max_time = max_time, 
